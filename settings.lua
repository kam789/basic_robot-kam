...
b.call_limit = { 50, 200, 1500, 10 ^ 9 }; -- how many execution calls per script run allowed, for auth levels 0,1,2 (bot, robot, puzzle, admin)
...
b.password = "thecowmoos";                -- IMPORTANT: change it before running mod, password used for authentifications
